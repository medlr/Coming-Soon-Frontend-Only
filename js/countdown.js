...
function countdown() {
  ...
  ctd.innerHTML =
    '<li><div><span class="heading_24">' +
    days +
    "</span><br> day" +
    (days > 1 ? "s" : "") +
    "</div></li>" +
    '<li><div><span class="heading_24 font_bold">' +
    hours +
    '</span><div class="pull-right"> hour' +
    (hours > 1 ? "s" : "") +
    "</div></div></li>" +
    '<li><div><span class="heading_24 font_bold">' +
    minutes +
    '</span><div class="pull-right"> minute' +
    (minutes > 1 ? "s" : "") +
    "</div></div></li>" +
    '<li><div><span class="heading_24 font_bold">' +
    seconds +
    '</span><div class="pull-right"> second' +
    (seconds > 1 ? "s" : "") +
    "</div></div></li>";
}
